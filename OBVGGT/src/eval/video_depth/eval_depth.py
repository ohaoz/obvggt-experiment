...
def _save_and_log_metrics(args, average_metrics, depth_log_path, swanlab_state):
...
def main(args):
    swanlab_state = init_swanlab_run(
        config=args,
        job_type="eval_video_depth",
        default_dataset=args.eval_dataset,
    ...
    if args.eval_dataset == "sintel":
        ...
        def get_video_results():
            ...
            _save_and_log_metrics(args, average_metrics, depth_log_path, swanlab_state)
